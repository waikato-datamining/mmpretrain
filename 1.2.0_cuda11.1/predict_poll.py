...
def process_image(fname, output_dir, poller):
    ...
    try:
        prediction = inference_model(poller.params.model, fname, poller.params.top_x)
...
def predict_on_images(input_dir, model, output_dir, tmp_dir, top_x=None,
    ...
    :type input_dir: str
    :param model: the mmclassification trained model
    ...
    :type tmp_dir: str
    :param top_x: whether to only return the top K predictions, all if None
    :type top_x: int
